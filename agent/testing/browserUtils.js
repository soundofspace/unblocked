...
exports.PageHooks = exports.createDefaultBrowser = exports.browserEngineOptions = exports.newPoolOptions = exports.defaultHooks = exports.defaultBrowserEngine = void 0;
...
class PageHooks {
    constructor(config = {}) {
        ...
        config.osPlatform ?? (config.osPlatform = this.operatingSystemPlatform);
