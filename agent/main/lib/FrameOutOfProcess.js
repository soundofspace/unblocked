...
class FrameOutOfProcess {
    constructor(page, frame) {
        ...
        this.page = page;
        this.frame = frame;
        this.networkManager = new NetworkManager_1.default(this.devtoolsSession, frame.logger, page.browserContext.proxy);
        this.domStorageTracker = new DomStorageTracker_1.default(page, page.browserContext.domStorage, this.networkManager, page.logger, page.domStorageTracker.isEnabled);
    }
    get browserContext() {
