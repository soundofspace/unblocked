...
export default class FramesManager extends TypedEventEmitter<IFrameManagerEvents> {
    ...
    websocketIdToFrameId: Map<string, string>;
    protected readonly logger: IBoundLog;
    private onFrameCreatedResourceEventsByFrameId;
    private get resources();
    private attachedFrameIds;
    private activeContextIdsBySessionId;
    private readonly events;
    private readonly networkManager;
    private readonly domStorageTracker;
    private isReady;
    private frameToContextId;
    constructor(page: Page, devtoolsSession: DevtoolsSession);
    initialize(devtoolsSession: DevtoolsSession): Promise<void>;
    reset(): void;
    close(error?: Error): void;
    addPageCallback(name: string, onCallback: (payload: string, frame: IFrame) => any, isolateFromWebPageEnvironment?: boolean, devtoolsSession?: DevtoolsSession): Promise<any>;
    addNewDocumentScript(script: string, installInIsolatedScope?: boolean, devtoolsSession?: DevtoolsSession): Promise<{
        identifier: string;
    }>;
    ...
    getFrameForExecutionContext(executionContextId: number): Frame | undefined;
    private onExecutionContextDestroyed;
    private onExecutionContextsCleared;
    private onExecutionContextCreated;
    private onExecutionContextCreatedNew;
    getExecutionContextId(opts: {
        frameId: string;
