...
export default class Page extends TypedEventEmitter<IPageLevelEvents> implements IPage {
    ...
    addNewDocumentScript(script: string, isolatedEnvironment: boolean, devtoolsSession?: DevtoolsSession): Promise<{
        identifier: string;
    }>;
    removeDocumentScript(identifier: string, devtoolsSession?: DevtoolsSession): Promise<void>;
    addPageCallback(name: string, onCallback?: (payload: string, frame: IFrame) => any, isolateFromWebPageEnvironment?: boolean, devtoolsSession?: DevtoolsSession): Promise<IRegisteredEventListener>;
    setJavaScriptEnabled(enabled: boolean): Promise<void>;
    evaluate<T>(expression: string, isolatedFromWebPageEnvironment?: boolean): Promise<T>;
