...
class Frame extends eventUtils_1.TypedEventEmitter {
    ...
    async evaluate(expression, isolateFromWebPageEnvironment, options) {
  ...
  return retVal;
})()`, this.page.installJsPathIntoIsolatedContext, { shouldAwaitExpression: false, retriesWaitingForLoad: 1 });
    }
