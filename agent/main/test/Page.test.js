  ...
  `);
    ...
    describe('screenshots', () => {
        ...
        it('should screenshot only the visible page', async () => {
            ...
            expect((0, image_size_1.default)(screenshot).height).toBe(viewport.innerHeight);
            expect((0, image_size_1.default)(screenshot).width).toBe(viewport.innerWidth);
        });
        it('should be able to take a clipped rect screenshot', async () => {
         ...
         <div style="height: 200px; width: 100px; background:red">&nbsp;</div>`);
            ...
            expect(screenshot.toString('base64')).toContain('ANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANAgKADQICgA0CAoANA');
        });
        ...
        <div style="height: 200px; width: 100px; background:red">&nbsp;</div>`);
            ...
            expect(screenshot.toString('base64')).toContain('AA0IHgAGhA8CA0AFgQOgAMCB0ABgQOgAMCB0ABoQOAANCB4ABoQPAgNABYEDoADAgdAAYEDoADAgdAAaEDgADQgeAAaEDwIDQAWBA6AAwIHQAGBA6AAwIHQAGhA4AA0IHgAGhA8CA0AFgQOgAMCB0ABgQOgAMCB0ABoQOAANCB4ABoQPAgNAB');
        });
    });
    describe('crash', () => {
