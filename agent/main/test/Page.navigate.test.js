...
describe('Page.navigate', () => {
    ...
    beforeAll(async () => {
        ...
        httpsServer = await server_1.TestServer.createHTTPS(0);
    ...
    describe('navigate', () => {
        ...
        it('should work with subframes return 204 with domcontentloaded', async () => {
            ...
            const wait = page.mainFrame.waitOn('frame-lifecycle', event => event.name === 'DOMContentLoaded');
        ...
        window.addEventListener(
          ...
          false,
            ...
            const waitForLoad = page.mainFrame.waitOn('frame-lifecycle', event => event.name === 'DOMContentLoaded');
        ...
        it('should be able to navigate to a page controlled by service worker', async () => {
            ...
            await expect(page.goto(`${server.baseUrl}/serviceworkers/fetch/sw.html`)).resolves.toBeTruthy();
        });
...
//# sourceMappingURL=Page.navigate.test.js.map