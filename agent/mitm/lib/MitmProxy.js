...
class MitmProxy {
    ...
    async addSecureContext(hostname) {
        ...
        (_a = this.secureContexts)[hostname] ?? (_a[hostname] = this.certificateGenerator
    ...
    registerProxySession(loopbackProxySocket, sessionId) {
        ...
        (_a = this.portsBySessionId)[sessionId] ?? (_a[sessionId] = new Set());
    ...
    static createCertificateGenerator(store, sslCaDir) {
        sslCaDir ?? (sslCaDir = env_1.default.defaultStorageDirectory);
