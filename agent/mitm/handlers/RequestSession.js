...
class RequestSession extends eventUtils_1.TypedEventEmitter {
    ...
    trackResourceRedirects(resource) {
        ...
        (_a = this.redirectsByRedirectedUrl)[_b = resource.redirectedToUrl] ?? (_a[_b] = []);
    ...
    async haveSentResponse(context) {
        for (const hook of this.hooks) {
    ...
    getWebsocketUpgradeRequestId(headers) {
        ...
        (_a = this.websocketBrowserResourceIds)[key] ?? (_a[key] = (0, utils_1.createPromise)(30e3));
    ...
    registerWebsocketHeaders(message) {
        ...
        (_a = this.websocketBrowserResourceIds)[key] ?? (_a[key] = (0, utils_1.createPromise)());
