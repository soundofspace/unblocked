...
declare type FilterOutFlags<Base, Condition> = {
    [Key in keyof Base]: Base[Key] extends Condition ? never : Key;
};
declare type DevtoolsCommandParams = {
    [Key in keyof ProtocolMapping.Commands]: ProtocolMapping.Commands[Key]['paramsType'][0];
};
declare type OptionalParamsCommands = keyof FilterFlags<DevtoolsCommandParams, void | never>;
declare type RequiredParamsCommands = keyof FilterOutFlags<DevtoolsCommandParams, void | never>;
