...
export declare type IDomPaintEvent = 'DomContentLoaded' | 'AllContentLoaded' | 'LargestContentfulPaint' | 'FirstContentfulPaint';
export declare type LocationStatus = keyof typeof LocationStatus;
export declare type ILoadStatus = keyof typeof LoadStatus;
export declare type ILocationTrigger = keyof typeof LocationTrigger;
