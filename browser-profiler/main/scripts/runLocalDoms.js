...
async function runLocalDoms(shouldRunDockers = defaultShouldRunDockers, shouldRunLocal = defaultShouldRunLocal) {
    const browserEngineOptions = await (0, getStableChromeVersions_1.default)(10);
    ...
    // cleanup tmp dir
    if (await (0, fileUtils_1.existsAsync)(tmpDir))
...
async function runLocalChromes(fullVersion, majorVersion, i) {
    ...
    const executablePath = await (0, ChromeUtils_1.getChromeExecutablePath)(fullVersion);
