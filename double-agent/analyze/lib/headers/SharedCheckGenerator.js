...
exports.extractOrderIndexMapFromArrays = void 0;
...
class SharedCheckGenerator {
    ...
    createDefaultValueChecks() {
        ...
        for (const page of this.data) {
            ...
            (_a = defaultValuesMap[protocol])[httpMethod] ?? (_a[httpMethod] = {});
            (_b = defaultValuesMap[protocol][httpMethod])[resourceType] ?? (_b[resourceType] = {});
            ...
            for (const [key, value] of page.rawHeaders) {
                ...
                resourceValues[lowerKey] ?? (resourceValues[lowerKey] = new Set());
    ...
    createHeaderOrderChecks(...excludeHeaders) {
        ...
        for (const page of this.data) {
            ...
            (_a = headerKeysMap[protocol])[httpMethod] ?? (_a[httpMethod] = {});
            (_b = headerKeysMap[protocol][httpMethod])[resourceKey] ?? (_b[resourceKey] = []);
