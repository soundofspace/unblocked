...
export declare type IHandlerFn = (ctx: IRequestContext) => Promise<void> | void;
declare type IRoutableServerProtocol = IServerProtocol | 'ws' | 'wss';
declare type IFlexibleServerProtocol = IRoutableServerProtocol | 'all' | 'allHttp1';
